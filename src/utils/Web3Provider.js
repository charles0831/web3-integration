...
import NFT from "abis/GLDToken.json";
...
export class Web3Provider extends React.Component {
  ...
  getBlockchainData = async () => {
    ...
    const nftToken = new window.web3.eth.Contract(
      NFT.abi,
      REACT_APP_ASTRO_TOKEN_ADDRESS
    );
